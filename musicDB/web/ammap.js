...
AmCharts.applyLang = function (a, b) {
    ...
    b.dayNames = AmCharts.extend({}, AmCharts.dayNames);
    b.shortDayNames = AmCharts.extend({}, AmCharts.shortDayNames);
    b.monthNames = AmCharts.extend({}, AmCharts.monthNames);
    b.shortMonthNames = AmCharts.extend({}, AmCharts.shortMonthNames);
    c && (c = c[a]) && (AmCharts.lang = c, c.monthNames && (b.dayNames = AmCharts.extend({}, c.dayNames), b.shortDayNames = AmCharts.extend({}, c.shortDayNames), b.monthNames = AmCharts.extend({}, c.monthNames), b.shortMonthNames = AmCharts.extend({},
    c.shortMonthNames)))
};
...
AmCharts.isNN && (document.addEventListener("mousemove", AmCharts.handleMouseMove, !0), document.addEventListener("mouseup", AmCharts.handleMouseUp, !0), window.addEventListener("load", AmCharts.handleLoad, !0), window.addEventListener("DOMMouseScroll", AmCharts.handleWheel, !0), document.addEventListener("mousewheel", AmCharts.handleWheel, !0));
...
AmCharts.clear = function () {
    ...
    AmCharts.resizeInt && clearInterval(AmCharts.resizeInt);
    AmCharts.charts = null;
    AmCharts.isNN && (document.removeEventListener("mousemove", AmCharts.handleMouseMove, !0), document.removeEventListener("mouseup", AmCharts.handleMouseUp, !0), window.removeEventListener("load", AmCharts.handleLoad, !0), window.removeEventListener("DOMMouseScroll", AmCharts.handleWheel, !0), document.removeEventListener("mousewheel", AmCharts.handleWheel, !0));
    AmCharts.isIE && (document.detachEvent("onmousemove", AmCharts.handleMouseMove), document.detachEvent("onmouseup", AmCharts.handleMouseUp), window.detachEvent("onload", AmCharts.handleLoad))
};
...
AmCharts.resizeInt = setInterval(function () {
    AmCharts.checkSize.call()
}, 200);
AmCharts.checkSize = function () {
    var a = AmCharts.charts;
    if (a) for (var b = 0; b < a.length; b++) a[b].validateSize()
};
AmCharts.bezierX = 3;
AmCharts.bezierY = 6;
...
AmCharts.processObject = function (a, b, c, d) {
    !1 === a instanceof b && (a = d ? AmCharts.extend(new b(c), a) : AmCharts.extend(a, new b(c), !0));
    return a
};
...
AmCharts.AmChart = AmCharts.Class({
    construct: function (a) {
        ...
        this.borderAlpha = this.backgroundAlpha = 1;
    ...
    write: function (a) {
        if (a = "object" != typeof a ? document.getElementById(a) : a) {
            ...
            b.className = this.classNamePrefix +
                "-chart-div";
            a.appendChild(h);
    ...
    initChart: function () {
        ...
        (a = this.container) ? (a.container.innerHTML =
            "", a.width = this.realWidth, a.height = this.realHeight, a.addDefs(this), this.chartDiv.appendChild(a.container)) : a = new AmCharts.AmDraw(this.chartDiv, this.realWidth, this.realHeight, this);
        a.chart = this;
    ...
    measure: function () {
        ...
        if (a) {
            ...
            var e = AmCharts.removePx(AmCharts.getStyle(a, "padding-left")),
                ...
                h = AmCharts.removePx(AmCharts.getStyle(a,
                    "padding-top")),
            ...
            d = Math.round(d);
            c = Math.round(c);
            a = Math.round(AmCharts.toCoordinate(this.width, c));
            e = Math.round(AmCharts.toCoordinate(this.height, d));
            (c != this.previousWidth || d != this.previousHeight) && 0 < a && 0 < e && (b.style.width = a + "px", b.style.height = e + "px",
            f && f.setSize(a, e), this.balloon = AmCharts.processObject(this.balloon, AmCharts.AmBalloon, this.theme), this.balloon.chart = this, this.balloon.setBounds(2, 2, a - 2, e));
            this.realWidth = a;
            this.realHeight = e;
            this.divRealWidth = c;
    ...
    addLegend: function (a, b) {
        a = AmCharts.processObject(a, AmCharts.AmLegend,
        this.theme);
        a.divId = b;
        var c;
    ...
    brr: function () {
        ...
        if ("amcharts.com" != b || !0 === this.inIframe()) {
            ...
            var g = "http://www.amcharts.com/javascript-charts/",
                h = "JavaScript charts",
                k = "JS chart by amCharts";
            "ammap" == this.product && (g = "http://www.ammap.com/javascript-maps/", h = "Interactive JavaScript maps", k = "JS map by amCharts");
            ...
            var h = e.offsetWidth,
                ...
                k = 5 + b,
                l = c + 5;
            "bottom-left" == a && (k = 5 + b, l = f - e - 3);
            "bottom-right" == a && (k = d - h - 5, l = f - e - 3);
            "top-right" == a && (k = d - h - 5, l = c + 5);
            g.left = k + "px";
            g.top = l + "px"
        }
    }
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function () {
        ...
        A = v.getBBox();
        k = A.height + 2 * l - 1;
        "left" == a || "right" == a ? (m = A.width + 2 * e, h = m + b + c, g.style.width = h + "px", this.ieW = h) : m = h - b - c - 1;
        c = AmCharts.polygon(this.container, [0, m, m, 0], [0, 0, k, k], this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
        AmCharts.setCN(this.chart, c, "legend-bg");
        y.push(c);
        y.translate(b, d);
        c.toBack();
        b = e;
        if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = e + (m - A.width) / 2 : "right" == this.align && (b = e + m - A.width);
        v.translate(b, l + 1);
    ...
    createEntry: function (a) {
        if (!1 !== a.visibleInLegend) {
            ...
            (e = this.switchType) && "none" != e && ("x" == e ? (c = this.createX(), c.translate(l / 2, l / 2)) : c = this.createV(), c.dItem = a, !0 !== a.hidden ? "x" == e ? c.hide() : c.show() : "x" != e && c.hide(), this.switchable || c.hide(), this.addListeners(c, a), a.legendSwitch = c, k.push(c), AmCharts.setCN(b, c, "legend-switch"));
            e = this.color;
            ...
            var z;
            d && (d = AmCharts.fixBrakes(d), a.legendTextReal = d, z = this.labelWidth, z = isNaN(z) ? AmCharts.text(this.container, d, e, b.fontFamily, c, "start") : AmCharts.wrappedText(this.container, d, e, b.fontFamily, c, "start", !1, z, 0), AmCharts.setCN(b, z, "legend-label"), z.translate(this.lx + m, this.ly), k.push(z), b = z.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
...
AmCharts.AmMap = AmCharts.Class({
    ...
    handleMouseMove: function (a) {
        ...
        if (a = b.mapContainer) {
            ...
            h = a.scale;
            b.isDragging && (b.hideBalloon(), b.positionChanged(), c = a.x + (f - c), d = a.y + (e - d), b.preventDragOut && (t = -t * h + l / 2, l /= 2, c = AmCharts.fitToBounds(c, -n * h + m / 2, m / 2), d = AmCharts.fitToBounds(d,
            t, l)), a.translate(c, d, h), b.updateSmallMap());
            b.previuosMouseX = f;
            b.previuosMouseY = e
        }
    },
    selectObject: function (a) {
        ...
        if (f = a.displayObject) {
            ...
            if (!a.preserveOriginalAttributes) {
                ...
                var l = a.imageLabel;
                l && (c = a.selectedLabelColorReal, void 0 !== c && l.setAttr("fill", c))
            }
            a.selectable || (f.setAttr("cursor", "default"), l && l.setAttr("cursor", "default"))
        } else b.returnInitialColorReal(a);
        if (f = a.groupId) for (l = b.getGroupById(f), c = 0; c < l.length; c++) if (k = l[c], k.isOver = !1, f = k.displayObject) if (h = k.selectedColorReal, void 0 !== e && f.setAttr("stroke", e), void 0 !== h ? f.setAttr("fill", h) : b.returnInitialColor(k), "MapLine" == k.objectType && ((h = k.lineSvg) && h.setAttr("stroke", g), k = k.arrowSvg)) k.setAttr("fill", g), k.setAttr("stroke",
        g);
